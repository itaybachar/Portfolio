...
projectData = `[{"projectName" : "Rubik's Cube V2", "projectDescription" : "Rubiks cube app written in Java that includes Real world cube recognition and Rubiks cube solver. With this a user can scan in their Rubik's Cube and recieve a step by step solution to how to solve it accompanied by a visual of a 3D Rubik's Cube.", "mediaAddress" : "res/rubiksPrev.png", "githubLink" : "https://github.com/itaybachar/RubiksCubeV2"},
...
{"projectName" : "Bezier Curve", "projectDescription" : "A Bezier Curve application written in Java. This does not uses the mathematical equation but it visualizes the curve using the logic of how the curve is made up.", "mediaAddress" : "res/bezierPrev.png", "githubLink" : "https://github.com/itaybachar/Bezier-Curve"}]`;